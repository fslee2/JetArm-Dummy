...
#ifndef LARGE_MODELS_MSGS__SRV__DETAIL__SET_CONTENT__FUNCTIONS_H_
#define LARGE_MODELS_MSGS__SRV__DETAIL__SET_CONTENT__FUNCTIONS_H_
...
/// Initialize srv/SetContent message.
/**
...
/// Finalize srv/SetContent message.
/**
...
/// Create srv/SetContent message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * large_models_msgs__srv__SetContent_Request__init().
...
/// Destroy srv/SetContent message.
/**
 * It calls
 * large_models_msgs__srv__SetContent_Request__fini()
...
/// Check for srv/SetContent message equality.
/**
...
/// Initialize array of srv/SetContent messages.
/**
...
/// Finalize array of srv/SetContent messages.
/**
 * It calls
 * large_models_msgs__srv__SetContent_Request__fini()
...
/// Create array of srv/SetContent messages.
/**
 * It allocates the memory for the array and calls
 * large_models_msgs__srv__SetContent_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/SetContent messages.
/**
 * It calls
 * large_models_msgs__srv__SetContent_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/SetContent message array equality.
/**
...
/// Copy an array of srv/SetContent messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * large_models_msgs__srv__SetContent_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_large_models_msgs
...
/**
 * It calls
 * large_models_msgs__srv__SetContent_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_large_models_msgs
...
/**
 * It allocates the memory for the array and calls
 * large_models_msgs__srv__SetContent_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_large_models_msgs
...
/**
 * It calls
 * large_models_msgs__srv__SetContent_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // LARGE_MODELS_MSGS__SRV__DETAIL__SET_CONTENT__FUNCTIONS_H_
