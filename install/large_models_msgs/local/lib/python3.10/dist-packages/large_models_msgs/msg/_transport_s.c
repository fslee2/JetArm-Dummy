...
bool large_models_msgs__msg__transport__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("large_models_msgs.msg._transport.Transport", full_classname_dest, 42) == 0);
  }
  large_models_msgs__msg__Transport * ros_message = _ros_message;
  {  // action
...
{
  /* NOTE(esteve): Call constructor of Transport */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("large_models_msgs.msg._transport");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "Transport");
