...
bool large_models_msgs__srv__set_model__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("large_models_msgs.srv._set_model.SetModel_Request", full_classname_dest, 49) == 0);
  }
  large_models_msgs__srv__SetModel_Request * ros_message = _ros_message;
  {  // platform
...
{
  /* NOTE(esteve): Call constructor of SetModel_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("large_models_msgs.srv._set_model");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetModel_Request");
...
ROSIDL_GENERATOR_C_EXPORT
bool large_models_msgs__srv__set_model__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("large_models_msgs.srv._set_model.SetModel_Response", full_classname_dest, 50) == 0);
  }
  large_models_msgs__srv__SetModel_Response * ros_message = _ros_message;
  {  // success
...
{
  /* NOTE(esteve): Call constructor of SetModel_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("large_models_msgs.srv._set_model");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SetModel_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
