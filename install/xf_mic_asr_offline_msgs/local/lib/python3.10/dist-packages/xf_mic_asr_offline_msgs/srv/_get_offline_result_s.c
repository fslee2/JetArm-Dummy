...
bool xf_mic_asr_offline_msgs__srv__get_offline_result__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xf_mic_asr_offline_msgs.srv._get_offline_result.GetOfflineResult_Request", full_classname_dest, 72) == 0);
  }
  xf_mic_asr_offline_msgs__srv__GetOfflineResult_Request * ros_message = _ros_message;
...
PyObject * xf_mic_asr_offline_msgs__srv__get_offline_result__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("xf_mic_asr_offline_msgs.srv._get_offline_result");
...
ROSIDL_GENERATOR_C_EXPORT
bool xf_mic_asr_offline_msgs__srv__get_offline_result__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("xf_mic_asr_offline_msgs.srv._get_offline_result.GetOfflineResult_Response", full_classname_dest, 73) == 0);
  }
  xf_mic_asr_offline_msgs__srv__GetOfflineResult_Response * ros_message = _ros_message;
  {  // result
