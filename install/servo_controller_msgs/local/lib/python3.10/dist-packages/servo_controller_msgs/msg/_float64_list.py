...
class Metaclass_Float64List(type):
    """Metaclass of message 'Float64List'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'servo_controller_msgs.msg.Float64List')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__float64_list
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__float64_list
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__float64_list
            cls._TYPE_SUPPORT = module.type_support_msg__msg__float64_list
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__float64_list
...
class Float64List(metaclass=Metaclass_Float64List):
    """Message class 'Float64List'."""
