...
#ifndef SERVO_CONTROLLER_MSGS__MSG__DETAIL__SERVO_STATE__FUNCTIONS_H_
#define SERVO_CONTROLLER_MSGS__MSG__DETAIL__SERVO_STATE__FUNCTIONS_H_
 ...
 * calls
 * servo_controller_msgs__msg__ServoState__init().
...
/**
 * It calls
 * servo_controller_msgs__msg__ServoState__fini()
 ...
 * servo_controller_msgs__msg__ServoState__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * servo_controller_msgs__msg__ServoState__Sequence__fini()
 * on the array,
...
#endif  // SERVO_CONTROLLER_MSGS__MSG__DETAIL__SERVO_STATE__FUNCTIONS_H_
