...
{
  new (message_memory) servo_controller_msgs::msg::ServosPosition(_init);
}

void ServosPosition_fini_function(void * message_memory)
{
  auto typed_message = static_cast<servo_controller_msgs::msg::ServosPosition *>(message_memory);
  typed_message->~ServosPosition();
}

size_t size_function__ServosPosition__position(const void * untyped_member)
{
  const auto * member = reinterpret_cast<const std::vector<servo_controller_msgs::msg::ServoPosition> *>(untyped_member);
  return member->size();
}
...
{
  const auto & member =
    *reinterpret_cast<const std::vector<servo_controller_msgs::msg::ServoPosition> *>(untyped_member);
  return &member[index];
}
...
{
  auto & member =
    *reinterpret_cast<std::vector<servo_controller_msgs::msg::ServoPosition> *>(untyped_member);
  return &member[index];
}
...
{
  const auto & item = *reinterpret_cast<const servo_controller_msgs::msg::ServoPosition *>(
    get_const_function__ServosPosition__position(untyped_member, index));
  auto & value = *reinterpret_cast<servo_controller_msgs::msg::ServoPosition *>(untyped_value);
  value = item;
}
...
{
  auto & item = *reinterpret_cast<servo_controller_msgs::msg::ServoPosition *>(
    get_function__ServosPosition__position(untyped_member, index));
  const auto & value = *reinterpret_cast<const servo_controller_msgs::msg::ServoPosition *>(untyped_value);
  item = value;
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServosPosition_message_member_array[3] = {
  {
    "duration",  // name
    ...
    offsetof(servo_controller_msgs::msg::ServosPosition, duration),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(servo_controller_msgs::msg::ServosPosition, position_unit),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // upper bound of string
    ::rosidl_typesupport_introspection_cpp::get_message_type_support_handle<servo_controller_msgs::msg::ServoPosition>(),  // members of sub message
    true,  // is array
    0,  // array size
    false,  // is upper bound
    offsetof(servo_controller_msgs::msg::ServosPosition, position),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServosPosition_message_members = {
  ...
  3,  // number of fields
  sizeof(servo_controller_msgs::msg::ServosPosition),
...
get_message_type_support_handle<servo_controller_msgs::msg::ServosPosition>()
{
  return &::servo_controller_msgs::msg::rosidl_typesupport_introspection_cpp::ServosPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, servo_controller_msgs, msg, ServosPosition)() {
  return &::servo_controller_msgs::msg::rosidl_typesupport_introspection_cpp::ServosPosition_message_type_support_handle;
}
