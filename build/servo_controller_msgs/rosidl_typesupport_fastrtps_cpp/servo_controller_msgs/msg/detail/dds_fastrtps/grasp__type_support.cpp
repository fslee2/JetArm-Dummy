...
#include "servo_controller_msgs/msg/detail/grasp__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const servo_controller_msgs::msg::Grasp & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  servo_controller_msgs::msg::Grasp & ros_message)
{
  // Member: mode
  cdr >> ros_message.mode;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_controller_msgs::msg::Grasp;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const servo_controller_msgs::msg::Grasp *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<servo_controller_msgs::msg::Grasp *>(
    untyped_ros_message);
...
get_message_type_support_handle<servo_controller_msgs::msg::Grasp>()
{
  return &servo_controller_msgs::msg::typesupport_fastrtps_cpp::_Grasp__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servo_controller_msgs, msg, Grasp)() {
  return &servo_controller_msgs::msg::typesupport_fastrtps_cpp::_Grasp__handle;
}
