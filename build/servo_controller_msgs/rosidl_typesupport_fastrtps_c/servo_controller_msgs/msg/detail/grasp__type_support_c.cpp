...
#include "servo_controller_msgs/msg/detail/grasp__rosidl_typesupport_fastrtps_c.h"
...
using _Grasp__ros_msg_type = servo_controller_msgs__msg__Grasp;
...
size_t get_serialized_size_servo_controller_msgs__msg__Grasp(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name grasp_posture
  {
    size_t item_size = sizeof(ros_message->grasp_posture);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // field.name pre_grasp_posture
  {
    size_t item_size = sizeof(ros_message->pre_grasp_posture);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _Grasp__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_servo_controller_msgs__msg__Grasp(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_servo_controller_msgs
size_t max_serialized_size_servo_controller_msgs__msg__Grasp(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_controller_msgs__msg__Grasp;
    is_plain =
      (
      offsetof(DataType, pre_grasp_posture) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _Grasp__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_servo_controller_msgs__msg__Grasp(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, servo_controller_msgs, msg, Grasp)() {
