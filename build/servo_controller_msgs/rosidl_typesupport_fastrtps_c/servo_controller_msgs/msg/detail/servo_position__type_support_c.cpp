...
#include "servo_controller_msgs/msg/detail/servo_position__rosidl_typesupport_fastrtps_c.h"
...
using _ServoPosition__ros_msg_type = servo_controller_msgs__msg__ServoPosition;
...
static uint32_t _ServoPosition__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_servo_controller_msgs__msg__ServoPosition(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = servo_controller_msgs__msg__ServoPosition;
    is_plain =
      (
...
static size_t _ServoPosition__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_servo_controller_msgs__msg__ServoPosition(
