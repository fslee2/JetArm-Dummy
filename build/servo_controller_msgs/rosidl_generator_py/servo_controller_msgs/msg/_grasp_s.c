...
bool servo_controller_msgs__msg__grasp__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("servo_controller_msgs.msg._grasp.Grasp", full_classname_dest, 38) == 0);
  }
  servo_controller_msgs__msg__Grasp * ros_message = _ros_message;
  {  // mode
  ...
  {  // pitch
    ...
    ros_message->pitch = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // angle
  ...
  {  // gripper
    ...
    assert(PyLong_Check(field));
    ros_message->gripper = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // grasp_posture
    ...
    assert(PyLong_Check(field));
    ros_message->grasp_posture = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
  {  // pre_grasp_posture
    ...
    assert(PyLong_Check(field));
    ros_message->pre_grasp_posture = (uint16_t)PyLong_AsUnsignedLong(field);
    Py_DECREF(field);
  }
...
PyObject * servo_controller_msgs__msg__grasp__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("servo_controller_msgs.msg._grasp");
  ...
  {  // pitch
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->pitch);
    {
  ...
  {  // grasp_posture
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->grasp_posture);
    {
  ...
  {  // pre_grasp_posture
    PyObject * field = NULL;
    field = PyLong_FromUnsignedLong(ros_message->pre_grasp_posture);
    {
