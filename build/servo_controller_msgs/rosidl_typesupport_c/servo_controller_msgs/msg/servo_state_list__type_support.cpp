...
static const _ServoStateList_type_support_symbol_names_t _ServoStateList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, servo_controller_msgs, msg, ServoStateList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, servo_controller_msgs, msg, ServoStateList)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, servo_controller_msgs, msg, ServoStateList)() {
  return &::servo_controller_msgs::msg::rosidl_typesupport_c::ServoStateList_message_type_support_handle;
}
