...
static const _ServoStateList_type_support_symbol_names_t _ServoStateList_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, servo_controller_msgs, msg, ServoStateList)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, servo_controller_msgs, msg, ServoStateList)),
  }
};
...
{
  return &::servo_controller_msgs::msg::rosidl_typesupport_cpp::ServoStateList_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, servo_controller_msgs, msg, ServoStateList)() {
  return get_message_type_support_handle<servo_controller_msgs::msg::ServoStateList>();
}
