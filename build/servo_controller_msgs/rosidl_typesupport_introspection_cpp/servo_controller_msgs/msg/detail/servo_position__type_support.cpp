...
{
  new (message_memory) servo_controller_msgs::msg::ServoPosition(_init);
}

void ServoPosition_fini_function(void * message_memory)
{
  auto typed_message = static_cast<servo_controller_msgs::msg::ServoPosition *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember ServoPosition_message_member_array[2] = {
  {
    ...
    offsetof(servo_controller_msgs::msg::ServoPosition, id),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(servo_controller_msgs::msg::ServoPosition, position),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers ServoPosition_message_members = {
  ...
  2,  // number of fields
  sizeof(servo_controller_msgs::msg::ServoPosition),
...
{
  return &::servo_controller_msgs::msg::rosidl_typesupport_introspection_cpp::ServoPosition_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, servo_controller_msgs, msg, ServoPosition)() {
  return &::servo_controller_msgs::msg::rosidl_typesupport_introspection_cpp::ServoPosition_message_type_support_handle;
}
