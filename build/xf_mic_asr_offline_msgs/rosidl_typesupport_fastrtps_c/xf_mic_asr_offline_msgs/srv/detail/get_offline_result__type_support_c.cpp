...
#include "xf_mic_asr_offline_msgs/srv/detail/get_offline_result__rosidl_typesupport_fastrtps_c.h"
...
#include "xf_mic_asr_offline_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _GetOfflineResult_Request__ros_msg_type = xf_mic_asr_offline_msgs__srv__GetOfflineResult_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xf_mic_asr_offline_msgs
size_t get_serialized_size_xf_mic_asr_offline_msgs__srv__GetOfflineResult_Request(
  const void * untyped_ros_message,
...
static uint32_t _GetOfflineResult_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_xf_mic_asr_offline_msgs__srv__GetOfflineResult_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xf_mic_asr_offline_msgs
size_t max_serialized_size_xf_mic_asr_offline_msgs__srv__GetOfflineResult_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = xf_mic_asr_offline_msgs__srv__GetOfflineResult_Request;
    is_plain =
      (
...
static size_t _GetOfflineResult_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xf_mic_asr_offline_msgs__srv__GetOfflineResult_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xf_mic_asr_offline_msgs, srv, GetOfflineResult_Request)() {
...
using _GetOfflineResult_Response__ros_msg_type = xf_mic_asr_offline_msgs__srv__GetOfflineResult_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xf_mic_asr_offline_msgs
size_t get_serialized_size_xf_mic_asr_offline_msgs__srv__GetOfflineResult_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _GetOfflineResult_Response__ros_msg_type * ros_message = static_cast<const _GetOfflineResult_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_xf_mic_asr_offline_msgs__srv__GetOfflineResult_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_xf_mic_asr_offline_msgs
size_t max_serialized_size_xf_mic_asr_offline_msgs__srv__GetOfflineResult_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = xf_mic_asr_offline_msgs__srv__GetOfflineResult_Response;
    is_plain =
      (
...
static size_t _GetOfflineResult_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_xf_mic_asr_offline_msgs__srv__GetOfflineResult_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xf_mic_asr_offline_msgs, srv, GetOfflineResult_Response)() {
...
// already included above
// #include "xf_mic_asr_offline_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "xf_mic_asr_offline_msgs/srv/get_offline_result.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, xf_mic_asr_offline_msgs, srv, GetOfflineResult)() {
