...
class Metaclass_GetOfflineResult_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('xf_mic_asr_offline_msgs')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_GetOfflineResult(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'xf_mic_asr_offline_msgs.srv.GetOfflineResult')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from xf_mic_asr_offline_msgs.srv import _get_offline_result
...
class GetOfflineResult(metaclass=Metaclass_GetOfflineResult):
    from xf_mic_asr_offline_msgs.srv._get_offline_result import GetOfflineResult_Request as Request
    from xf_mic_asr_offline_msgs.srv._get_offline_result import GetOfflineResult_Response as Response
