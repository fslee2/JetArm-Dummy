...
{
public:
  explicit Init_ObjectInfo_angle(::interfaces::msg::ObjectInfo & msg)
  : msg_(msg)
  {}
  Init_ObjectInfo_score angle(::interfaces::msg::ObjectInfo::_angle_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_ObjectInfo_angle box(::interfaces::msg::ObjectInfo::_box_type arg)
  {
