...
#include "large_models_msgs/msg/detail/transport__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // action, object_name
#include "rosidl_runtime_c/string_functions.h"  // action, object_name

// forward declare type support functions


using _Transport__ros_msg_type = large_models_msgs__msg__Transport;

static bool _Transport__cdr_serialize(
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  const _Transport__ros_msg_type * ros_message = static_cast<const _Transport__ros_msg_type *>(untyped_ros_message);
  // Field name: action
  {
...
static bool _Transport__cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  void * untyped_ros_message)
{
  ...
  _Transport__ros_msg_type * ros_message = static_cast<_Transport__ros_msg_type *>(untyped_ros_message);
  // Field name: action
  {
    std::string tmp;
    cdr >> tmp;
...
static uint32_t _Transport__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_large_models_msgs__msg__Transport(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = large_models_msgs__msg__Transport;
    is_plain =
      (
...
static size_t _Transport__max_serialized_size(char & bounds_info)
{
  bool full_bounded;
  bool is_plain;
  size_t ret_val;

  ret_val = max_serialized_size_large_models_msgs__msg__Transport(
...
static message_type_support_callbacks_t __callbacks_Transport = {
  "large_models_msgs::msg",
  "Transport",
  _Transport__cdr_serialize,
  _Transport__cdr_deserialize,
  _Transport__get_serialized_size,
  _Transport__max_serialized_size
};

static rosidl_message_type_support_t _Transport__type_support = {
  rosidl_typesupport_fastrtps_c__identifier,
  &__callbacks_Transport,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, large_models_msgs, msg, Transport)() {
  return &_Transport__type_support;
}
