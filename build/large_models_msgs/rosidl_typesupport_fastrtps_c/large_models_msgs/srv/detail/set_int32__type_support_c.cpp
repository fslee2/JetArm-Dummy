...
#include "large_models_msgs/srv/detail/set_int32__rosidl_typesupport_fastrtps_c.h"
...
using _SetInt32_Request__ros_msg_type = large_models_msgs__srv__SetInt32_Request;
...
size_t get_serialized_size_large_models_msgs__srv__SetInt32_Request(
  const void * untyped_ros_message,
...
static uint32_t _SetInt32_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_large_models_msgs__srv__SetInt32_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_large_models_msgs
size_t max_serialized_size_large_models_msgs__srv__SetInt32_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = large_models_msgs__srv__SetInt32_Request;
    is_plain =
      (
...
static size_t _SetInt32_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_large_models_msgs__srv__SetInt32_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, large_models_msgs, srv, SetInt32_Request)() {
...
using _SetInt32_Response__ros_msg_type = large_models_msgs__srv__SetInt32_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_large_models_msgs
size_t get_serialized_size_large_models_msgs__srv__SetInt32_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetInt32_Response__ros_msg_type * ros_message = static_cast<const _SetInt32_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_large_models_msgs__srv__SetInt32_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_large_models_msgs
size_t max_serialized_size_large_models_msgs__srv__SetInt32_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = large_models_msgs__srv__SetInt32_Response;
    is_plain =
      (
...
static size_t _SetInt32_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_large_models_msgs__srv__SetInt32_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, large_models_msgs, srv, SetInt32_Response)() {
...
// already included above
// #include "large_models_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "large_models_msgs/srv/set_int32.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, large_models_msgs, srv, SetInt32)() {
