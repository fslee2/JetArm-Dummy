...
#include "large_models_msgs/srv/detail/set_model__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = large_models_msgs::srv::SetModel_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const large_models_msgs::srv::SetModel_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<large_models_msgs::srv::SetModel_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetModel_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const large_models_msgs::srv::SetModel_Request *>(
...
static size_t _SetModel_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetModel_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetModel_Request__callbacks = {
...
static rosidl_message_type_support_t _SetModel_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetModel_Request__callbacks,
...
{
  return &large_models_msgs::srv::typesupport_fastrtps_cpp::_SetModel_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = large_models_msgs::srv::SetModel_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const large_models_msgs::srv::SetModel_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<large_models_msgs::srv::SetModel_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _SetModel_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const large_models_msgs::srv::SetModel_Response *>(
...
static size_t _SetModel_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_SetModel_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _SetModel_Response__callbacks = {
  "large_models_msgs::srv",
  "SetModel_Response",
...
static rosidl_message_type_support_t _SetModel_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetModel_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &large_models_msgs::srv::typesupport_fastrtps_cpp::_SetModel_Response__handle;
}
...
static service_type_support_callbacks_t _SetModel__callbacks = {
  "large_models_msgs::srv",
  "SetModel",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, large_models_msgs, srv, SetModel_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, large_models_msgs, srv, SetModel_Response)(),
...
static rosidl_service_type_support_t _SetModel__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_SetModel__callbacks,
...
{
  return &large_models_msgs::srv::typesupport_fastrtps_cpp::_SetModel__handle;
}
