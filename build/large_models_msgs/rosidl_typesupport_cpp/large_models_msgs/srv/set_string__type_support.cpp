...
#include "large_models_msgs/srv/detail/set_string__struct.hpp"
...
static const _SetString_Request_type_support_symbol_names_t _SetString_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, large_models_msgs, srv, SetString_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, large_models_msgs, srv, SetString_Request)),
  }
};
...
get_message_type_support_handle<large_models_msgs::srv::SetString_Request>()
{
  return &::large_models_msgs::srv::rosidl_typesupport_cpp::SetString_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, large_models_msgs, srv, SetString_Request)() {
  return get_message_type_support_handle<large_models_msgs::srv::SetString_Request>();
}
...
static const _SetString_Response_type_support_symbol_names_t _SetString_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, large_models_msgs, srv, SetString_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, large_models_msgs, srv, SetString_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<large_models_msgs::srv::SetString_Response>()
{
  return &::large_models_msgs::srv::rosidl_typesupport_cpp::SetString_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, large_models_msgs, srv, SetString_Response)() {
  return get_message_type_support_handle<large_models_msgs::srv::SetString_Response>();
}
...
static const _SetString_type_support_symbol_names_t _SetString_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, large_models_msgs, srv, SetString)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, large_models_msgs, srv, SetString)),
  }
};
...
get_service_type_support_handle<large_models_msgs::srv::SetString>()
{
  return &::large_models_msgs::srv::rosidl_typesupport_cpp::SetString_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, large_models_msgs, srv, SetString)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<large_models_msgs::srv::SetString>();
}
