...
static const _Transport_type_support_symbol_names_t _Transport_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, large_models_msgs, msg, Transport)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, large_models_msgs, msg, Transport)),
  }
};
...
{
  return &::large_models_msgs::msg::rosidl_typesupport_cpp::Transport_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, large_models_msgs, msg, Transport)() {
  return get_message_type_support_handle<large_models_msgs::msg::Transport>();
}
