...
#include "kinematics_msgs/msg/detail/link__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const kinematics_msgs::msg::Link & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  kinematics_msgs::msg::Link & ros_message)
{
  // Member: base_link
  cdr >> ros_message.base_link;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinematics_msgs::msg::Link;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kinematics_msgs::msg::Link *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kinematics_msgs::msg::Link *>(
    untyped_ros_message);
...
{
  return &kinematics_msgs::msg::typesupport_fastrtps_cpp::_Link__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, kinematics_msgs, msg, Link)() {
  return &kinematics_msgs::msg::typesupport_fastrtps_cpp::_Link__handle;
}
