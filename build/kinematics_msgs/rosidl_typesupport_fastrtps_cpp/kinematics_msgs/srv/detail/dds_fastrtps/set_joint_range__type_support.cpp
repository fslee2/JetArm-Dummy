...
#include "kinematics_msgs/srv/detail/set_joint_range__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinematics_msgs::srv::SetJointRange_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kinematics_msgs::srv::SetJointRange_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<kinematics_msgs::srv::SetJointRange_Request *>(
    untyped_ros_message);
...
{
  return &kinematics_msgs::srv::typesupport_fastrtps_cpp::_SetJointRange_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kinematics_msgs::srv::SetJointRange_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const kinematics_msgs::srv::SetJointRange_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<kinematics_msgs::srv::SetJointRange_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &kinematics_msgs::srv::typesupport_fastrtps_cpp::_SetJointRange_Response__handle;
}
...
static rosidl_service_type_support_t _SetJointRange__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
...
{
  return &kinematics_msgs::srv::typesupport_fastrtps_cpp::_SetJointRange__handle;
}
