...
bool kinematics_msgs__msg__link__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("kinematics_msgs.msg._link.Link", full_classname_dest, 30) == 0);
  }
  kinematics_msgs__msg__Link * ros_message = _ros_message;
  {  // base_link
...
PyObject * kinematics_msgs__msg__link__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("kinematics_msgs.msg._link");
