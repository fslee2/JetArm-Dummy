...
#include "kinematics_msgs/msg/detail/joint_range__rosidl_typesupport_fastrtps_c.h"
...
using _JointRange__ros_msg_type = kinematics_msgs__msg__JointRange;
  ...
  void * untyped_ros_message)
{
  ...
  _JointRange__ros_msg_type * ros_message = static_cast<_JointRange__ros_msg_type *>(untyped_ros_message);
  // Field name: min
  {
    cdr >> ros_message->min;
  }
...
static uint32_t _JointRange__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kinematics_msgs__msg__JointRange(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinematics_msgs__msg__JointRange;
    is_plain =
      (
...
static size_t _JointRange__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kinematics_msgs__msg__JointRange(
