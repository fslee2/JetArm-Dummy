...
#include "kinematics_msgs/srv/detail/set_joint_range__rosidl_typesupport_fastrtps_c.h"
...
using _SetJointRange_Request__ros_msg_type = kinematics_msgs__srv__SetJointRange_Request;
  ...
  void * untyped_ros_message)
{
  ...
  _SetJointRange_Request__ros_msg_type * ros_message = static_cast<_SetJointRange_Request__ros_msg_type *>(untyped_ros_message);
  // Field name: data
  {
    const message_type_support_callbacks_t * callbacks =
      static_cast<const message_type_support_callbacks_t *>(
...
size_t get_serialized_size_kinematics_msgs__srv__SetJointRange_Request(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetJointRange_Request__ros_msg_type * ros_message = static_cast<const _SetJointRange_Request__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _SetJointRange_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_kinematics_msgs__srv__SetJointRange_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kinematics_msgs
size_t max_serialized_size_kinematics_msgs__srv__SetJointRange_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = kinematics_msgs__srv__SetJointRange_Request;
    is_plain =
      (
...
static size_t _SetJointRange_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kinematics_msgs__srv__SetJointRange_Request(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kinematics_msgs, srv, SetJointRange_Request)() {
...
using _SetJointRange_Response__ros_msg_type = kinematics_msgs__srv__SetJointRange_Response;
  ...
  void * untyped_ros_message)
{
  ...
  _SetJointRange_Response__ros_msg_type * ros_message = static_cast<_SetJointRange_Response__ros_msg_type *>(untyped_ros_message);
  // Field name: success
  {
    uint8_t tmp;
    cdr >> tmp;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kinematics_msgs
size_t get_serialized_size_kinematics_msgs__srv__SetJointRange_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _SetJointRange_Response__ros_msg_type * ros_message = static_cast<const _SetJointRange_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_kinematics_msgs__srv__SetJointRange_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_kinematics_msgs
size_t max_serialized_size_kinematics_msgs__srv__SetJointRange_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = kinematics_msgs__srv__SetJointRange_Response;
    is_plain =
      (
...
static size_t _SetJointRange_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_kinematics_msgs__srv__SetJointRange_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kinematics_msgs, srv, SetJointRange_Response)() {
...
// already included above
// #include "kinematics_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "kinematics_msgs/srv/set_joint_range.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kinematics_msgs, srv, SetJointRange)() {
