...
static const _GetRobotPose_Request_type_support_symbol_names_t _GetRobotPose_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kinematics_msgs, srv, GetRobotPose_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kinematics_msgs, srv, GetRobotPose_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kinematics_msgs, srv, GetRobotPose_Request)() {
  return &::kinematics_msgs::srv::rosidl_typesupport_c::GetRobotPose_Request_message_type_support_handle;
}
...
static const _GetRobotPose_Response_type_support_symbol_names_t _GetRobotPose_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kinematics_msgs, srv, GetRobotPose_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kinematics_msgs, srv, GetRobotPose_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, kinematics_msgs, srv, GetRobotPose_Response)() {
  return &::kinematics_msgs::srv::rosidl_typesupport_c::GetRobotPose_Response_message_type_support_handle;
}
...
static const _GetRobotPose_type_support_symbol_names_t _GetRobotPose_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, kinematics_msgs, srv, GetRobotPose)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, kinematics_msgs, srv, GetRobotPose)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, kinematics_msgs, srv, GetRobotPose)() {
  return &::kinematics_msgs::srv::rosidl_typesupport_c::GetRobotPose_service_type_support_handle;
}
