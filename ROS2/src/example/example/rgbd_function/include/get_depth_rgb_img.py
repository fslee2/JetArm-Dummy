...
# Convert the depth map to a pseudo-color image. 将深度图转换为伪彩色图像，
# A pseudo-color image means displaying different colors for different distances. 伪彩色图即距离不同回显示不同的颜色
