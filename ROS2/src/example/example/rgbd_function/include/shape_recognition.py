...
class ObjectClassificationNode(Node):
    ...
    def get_contours(self, depth_image, min_dist):
        ...
        depth_image = np.where(depth_image > min_dist + 20, 0, depth_image)  # Set the pixels with a depth value greater than the minimum distance of 15mm to 0. 将深度值大于最小距离15mm的像素置0
